...
Public Class Edge
    ...
    Private Sub Edge_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_d1bff44cae164c5aa57c4bd99058c386.zip"), Texbbb.TextBox4.Text)
